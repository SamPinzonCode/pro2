...
if len(lista)>0:
    ...
    with open("Numeros.txt","a") as Numeros:
        Numeros.write(f"Nuevo Ingreso....\n")
        Numeros.write(f"La cantidad de datos ingresados es: {cantidad_numbers}.\n La suma total de los datos ingresados es de: {total}.\n El promedio fue de: {prom:.2f}.\n El numero mayor ingresado fue: {maximo}.\nEl numero minimo ingresado fue: {minimo}")
